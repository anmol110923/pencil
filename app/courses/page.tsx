              ...
              <CardContent>
                <div className="prose prose-gray dark:prose-invert max-w-none">
                  ...
                  <ul className="space-y-2">
                    <li>Clear understanding of core concepts in your subject</li>
                    <li>Quick revision using one-shot videos</li>
                    <li>Detailed notes and practical files for reference</li>
                    <li>Access to previous year questions (PYQs)</li>
                    <li>Exam-oriented tips and strategies</li>
                    <li>Hands-on practice with examples and exercises</li>
                  </ul>
                </div>
              </CardContent>
            </Card>
